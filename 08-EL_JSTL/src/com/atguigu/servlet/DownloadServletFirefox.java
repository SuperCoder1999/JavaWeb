...
/**
 * 下载文件扩展: 解决 文件名为中文的情况(针对 Firefox浏览器)
 */
public class DownloadServletFirefox extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 将文件名 用 base64编码的形式写进请求头.(因为请求头的字符集是由http决定的,只支持英文)
        String str = new BASE64Encoder().encode("妹妹.jpg".getBytes("utf-8"));
        String filename = "=?UTF-8?B?" + str + "?=";
